...
public class SubmissionResponse {
    ...
    public SubmissionResponse(String id, String fullName, String email, String qualification, double experience, 
    ...
    public static class Builder {
        ...
        public SubmissionResponse build() {
            return new SubmissionResponse(id, fullName, email, qualification, experience, profession, careerGoal, recommendation, reason, nextSteps, createdAt);
        }
    }
}
